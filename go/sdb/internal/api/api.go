...
type IterationMessage struct {
	...
	//	*IterationMessage_Snapshot_
	//	*IterationMessage_Message
	//	*IterationMessage_Eof_
	Content              isIterationMessage_Content `protobuf_oneof:"content"`
	XXX_NoUnkeyedLiteral struct{}                   `json:"-"`
	XXX_unrecognized     []byte                     `json:"-"`
	XXX_sizecache        int32                      `json:"-"`
}

func (m *IterationMessage) Reset()         { *m = IterationMessage{} }
func (m *IterationMessage) String() string { return proto.CompactTextString(m) }
func (*IterationMessage) ProtoMessage()    {}
func (*IterationMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_1b40cafcd4234784, []int{13}
}

func (m *IterationMessage) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_IterationMessage.Unmarshal(m, b)
}
func (m *IterationMessage) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_IterationMessage.Marshal(b, m, deterministic)
}
func (m *IterationMessage) XXX_Merge(src proto.Message) {
	xxx_messageInfo_IterationMessage.Merge(m, src)
}
func (m *IterationMessage) XXX_Size() int {
	return xxx_messageInfo_IterationMessage.Size(m)
}
func (m *IterationMessage) XXX_DiscardUnknown() {
	xxx_messageInfo_IterationMessage.DiscardUnknown(m)
}

var xxx_messageInfo_IterationMessage proto.InternalMessageInfo

type isIterationMessage_Content interface {
	isIterationMessage_Content()
}

type IterationMessage_Snapshot_ struct {
	Snapshot *IterationMessage_Snapshot `protobuf:"bytes,1,opt,name=snapshot,proto3,oneof"`
}

type IterationMessage_Message struct {
	Message *Message `protobuf:"bytes,2,opt,name=message,proto3,oneof"`
}

type IterationMessage_Eof_ struct {
	Eof *IterationMessage_Eof `protobuf:"bytes,3,opt,name=eof,proto3,oneof"`
}

func (*IterationMessage_Snapshot_) isIterationMessage_Content() {}

func (*IterationMessage_Message) isIterationMessage_Content() {}

func (*IterationMessage_Eof_) isIterationMessage_Content() {}

func (m *IterationMessage) GetContent() isIterationMessage_Content {
	if m != nil {
		return m.Content
	}
	return nil
...
func (m *IterationMessage) GetSnapshot() *IterationMessage_Snapshot {
	if x, ok := m.GetContent().(*IterationMessage_Snapshot_); ok {
		return x.Snapshot
	}
	return nil
}

func (m *IterationMessage) GetMessage() *Message {
	if x, ok := m.GetContent().(*IterationMessage_Message); ok {
		return x.Message
	}
	return nil
}

func (m *IterationMessage) GetEof() *IterationMessage_Eof {
	if x, ok := m.GetContent().(*IterationMessage_Eof_); ok {
		return x.Eof
	}
	return nil
}
...
func (*IterationMessage) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*IterationMessage_Snapshot_)(nil),
		(*IterationMessage_Message)(nil),
		(*IterationMessage_Eof_)(nil),
	}
}

type IterationMessage_Snapshot struct {
...
func (m *IterationMessage_Snapshot) Reset()         { *m = IterationMessage_Snapshot{} }
func (m *IterationMessage_Snapshot) String() string { return proto.CompactTextString(m) }
func (*IterationMessage_Snapshot) ProtoMessage()    {}
func (*IterationMessage_Snapshot) Descriptor() ([]byte, []int) {
	return fileDescriptor_1b40cafcd4234784, []int{13, 0}
}

func (m *IterationMessage_Snapshot) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_IterationMessage_Snapshot.Unmarshal(m, b)
}
func (m *IterationMessage_Snapshot) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_IterationMessage_Snapshot.Marshal(b, m, deterministic)
}
func (m *IterationMessage_Snapshot) XXX_Merge(src proto.Message) {
	xxx_messageInfo_IterationMessage_Snapshot.Merge(m, src)
}
func (m *IterationMessage_Snapshot) XXX_Size() int {
	return xxx_messageInfo_IterationMessage_Snapshot.Size(m)
}
func (m *IterationMessage_Snapshot) XXX_DiscardUnknown() {
	xxx_messageInfo_IterationMessage_Snapshot.DiscardUnknown(m)
}

var xxx_messageInfo_IterationMessage_Snapshot proto.InternalMessageInfo

func (m *IterationMessage_Snapshot) GetHead() int64 {
	if m != nil {
		return m.Head
	}
	return 0
...
func (m *IterationMessage_Snapshot) GetVersion() int64 {
	if m != nil {
		return m.Version
	}
	return 0
...
type IterationMessage_Eof struct {
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *IterationMessage_Eof) Reset()         { *m = IterationMessage_Eof{} }
func (m *IterationMessage_Eof) String() string { return proto.CompactTextString(m) }
func (*IterationMessage_Eof) ProtoMessage()    {}
func (*IterationMessage_Eof) Descriptor() ([]byte, []int) {
	return fileDescriptor_1b40cafcd4234784, []int{13, 1}
}

func (m *IterationMessage_Eof) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_IterationMessage_Eof.Unmarshal(m, b)
}
func (m *IterationMessage_Eof) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_IterationMessage_Eof.Marshal(b, m, deterministic)
}
func (m *IterationMessage_Eof) XXX_Merge(src proto.Message) {
	xxx_messageInfo_IterationMessage_Eof.Merge(m, src)
}
func (m *IterationMessage_Eof) XXX_Size() int {
	return xxx_messageInfo_IterationMessage_Eof.Size(m)
}
func (m *IterationMessage_Eof) XXX_DiscardUnknown() {
	xxx_messageInfo_IterationMessage_Eof.DiscardUnknown(m)
}

var xxx_messageInfo_IterationMessage_Eof proto.InternalMessageInfo
...
type IterateStreamRequest struct {
	Database             string   `protobuf:"bytes,1,opt,name=database,proto3" json:"database,omitempty"`
	Stream               string   `protobuf:"bytes,2,opt,name=stream,proto3" json:"stream,omitempty"`
	From                 int64    `protobuf:"varint,3,opt,name=from,proto3" json:"from,omitempty"`
	Limit                uint32   `protobuf:"varint,4,opt,name=limit,proto3" json:"limit,omitempty"`
	Reverse              bool     `protobuf:"varint,5,opt,name=reverse,proto3" json:"reverse,omitempty"`
	KeepOpen             bool     `protobuf:"varint,6,opt,name=keepOpen,proto3" json:"keepOpen,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *IterateStreamRequest) Reset()         { *m = IterateStreamRequest{} }
func (m *IterateStreamRequest) String() string { return proto.CompactTextString(m) }
func (*IterateStreamRequest) ProtoMessage()    {}
func (*IterateStreamRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_1b40cafcd4234784, []int{28}
}

func (m *IterateStreamRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_IterateStreamRequest.Unmarshal(m, b)
}
func (m *IterateStreamRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_IterateStreamRequest.Marshal(b, m, deterministic)
}
func (m *IterateStreamRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_IterateStreamRequest.Merge(m, src)
}
func (m *IterateStreamRequest) XXX_Size() int {
	return xxx_messageInfo_IterateStreamRequest.Size(m)
}
func (m *IterateStreamRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_IterateStreamRequest.DiscardUnknown(m)
}

var xxx_messageInfo_IterateStreamRequest proto.InternalMessageInfo

func (m *IterateStreamRequest) GetDatabase() string {
	if m != nil {
		return m.Database
	}
	return ""
...
func (m *IterateStreamRequest) GetStream() string {
	if m != nil {
		return m.Stream
	}
	return ""
...
func (m *IterateStreamRequest) GetFrom() int64 {
	if m != nil {
		return m.From
	}
	return 0
...
func (m *IterateStreamRequest) GetLimit() uint32 {
	if m != nil {
		return m.Limit
	}
	return 0
...
func (m *IterateStreamRequest) GetReverse() bool {
	if m != nil {
		return m.Reverse
	}
	return false
...
func (m *IterateStreamRequest) GetKeepOpen() bool {
	if m != nil {
		return m.KeepOpen
	}
	return false
...
func init() {
	...
	proto.RegisterType((*IterationMessage)(nil), "streamsdb.api.IterationMessage")
	proto.RegisterType((*IterationMessage_Snapshot)(nil), "streamsdb.api.IterationMessage.Snapshot")
	proto.RegisterType((*IterationMessage_Eof)(nil), "streamsdb.api.IterationMessage.Eof")
	...
	proto.RegisterType((*IterateStreamRequest)(nil), "streamsdb.api.IterateStreamRequest")
...
var fileDescriptor_1b40cafcd4234784 = []byte{
	...
	,
}
...
type StreamsClient interface {
	...
	IterateStream(ctx context.Context, in *IterateStreamRequest, opts ...grpc.CallOption) (Streams_IterateStreamClient, error)
...
func (c *streamsClient) IterateStream(ctx context.Context, in *IterateStreamRequest, opts ...grpc.CallOption) (Streams_IterateStreamClient, error) {
...
func (x *streamsIterateStreamClient) Recv() (*IterationMessage, error) {
	m := new(IterationMessage)
...
func (c *streamsClient) SubscribeStream(ctx context.Context, in *SubscribeStreamRequest, opts ...grpc.CallOption) (Streams_SubscribeStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Streams_serviceDesc.Streams[1], "/streamsdb.api.Streams/SubscribeStream", opts...)
	if err != nil {
		return nil, err
	}
...
type StreamsServer interface {
	...
	IterateStream(*IterateStreamRequest, Streams_IterateStreamServer) error
...
func (*UnimplementedStreamsServer) IterateStream(req *IterateStreamRequest, srv Streams_IterateStreamServer) error {
...
func (x *streamsIterateStreamServer) Send(m *IterationMessage) error {
